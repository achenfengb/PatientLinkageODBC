...
/**
 * DatabaseConnection.java Purpose: This class connects to a MySQL database for
 * reading/writing
 *
...
public class DatabaseConnection {
    ...
    /**
     * Establish a connection to a database so that reading or writing may take
     * place
     *
    ...
    /**
     * Execute a query on a MySQL database. Can be used to execute any valid
     * MySQL query.
     *
    ...
    /**
     * This function queries MySQL to determine whether a table 'table' exists
    ...
    /**
     * This function queries the currently connected database for an entire
     * table of data & returns it as an SQL ResultSet.
     *
    ...
    /**
     * Given some valid MySQL SELECT query, return it as a MySQL ResultSet. This
     * just wraps a Try-Catch and some error checking stuff.
     *
    ...
    /**
     * Given a ResultSet with a table from a selection statement get the number
    ...
    /**
     * Given the ResultMetaData for some ResultSet containing SQL table data,
    ...
    /**
     * Given the ResultSetMetaData for some ResultSet containing SQL table data,
     * get the names of each column for the table.
     *
     * @param sqlRSMD MetaData for ResultSet with table data
     * @return an array of strings containing the names of each attribute of the
     * table, in order
     */
    ...
    /**
     * Given some sqlResults from a SQL query, get the next row in the result
     * set as a String array. Moves the ResultSet cursor forward one position.
     *
     * @param sqlResults - The result set of some database query
     * @return - One row from the SQL Results as an Array of Strings, null if
     * there is no data
     */
    ...
    /**
     * Given some sqlResults from a SQL query, get the next row in the result
     * set as a String array with the column name in the first row and the value
     * in the second row. Moves the ResultSet cursor forward one position.
     *
     * @param sqlResults - The result set of some database query
     * @return - One row from the SQL Results as an Array of Strings, null if
     * there is no data
